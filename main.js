function criptografar() {
    ...
    const textoCriptografado = texto.replace(/e/g, 'enter').replace(/i/g, 'imes').replace(/a/g, 'ai')
...
function descriptografar() {
    const texto = entrada.value;
    const textoDescriptografado = texto.replace(/enter/g, 'e').replace(/imes/g, 'i').replace(/ai/g, 'a')
...
function mostraResultado(texto) {
    ...
    resultado.innerHTML = '<textarea type="text" id="saida" readonly>' + texto + '</textarea>' + 
